...
* Доработка проекта (удаление ненужных анатаций @Transactional, создание большего количества собственных исключений и т. д.), приведение кода в нормальный вид - 13.01.2025
...
В проекте уже есть таблица всех продуктов интернет-магазина, остаётся лишь добавить к данной таблице фичи, которые описаны выше - 16.01.2025 - 18.01.2025
