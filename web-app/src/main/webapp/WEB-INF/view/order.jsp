    ...
    <div class="mt-4">
        <div class="d-flex">
            ...
            <input type="button" class="btn btn-primary mx-3" value="<fmt:message key='order.ordersTable' bundle='${lang}' />"
                   onclick="window.location.href='${pageContext.request.contextPath}/orders'">
        </div>
        <hr>
        <br>
            ...
            <c:forEach var="orderItem" items="${requestScope.orderDto.getOrderItems()}">
                <div class="col-lg-3 col-md-6">
                    <div class="card mt-2 mb-2" style="width: 17.5rem;height: 24rem">
                        <a href="${pageContext.request.contextPath}/products/${orderItem.getProduct().getId()}">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <img src="${pageContext.request.contextPath}/images/${orderItem.getProduct().getImageList().get(0).getId()}"
                                         class="card-img-top"/>
                                </c:otherwise>
                            </c:choose>
                        </a>
