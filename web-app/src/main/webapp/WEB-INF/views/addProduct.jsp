...
<div class="add-product">
    <form action="${pageContext.request.contextPath}/manager/product/add" method="post" enctype="multipart/form-data">
        ...
        <input class="form-control" type="text" id="name" minlength="3" name="name" placeholder="<fmt:message key='product.adding.name.placeholder' bundle='${lang}'/>" required>

        <label for="category" class="form-label"><fmt:message key="product.adding.category" bundle="${lang}"/></label>
        <input class="form-control" type="text" id="category" minlength="3" name="category" placeholder="<fmt:message key='product.adding.category.placeholder' bundle='${lang}'/>" required>

        <label for="description" class="form-label"><fmt:message key="product.adding.description" bundle="${lang}"/></label>
        ...
        <input class="form-control" id="amount" type="number" min="20" placeholder="<fmt:message key='product.adding.amount.placeholder' bundle='${lang}'/>" step="1" name="amount" required>

        <label for="coast" class="form-label"><fmt:message key="product.adding.coast" bundle="${lang}"/></label>
        <input type="number" class="form-control" id="coast" min="0.01" placeholder="<fmt:message key='product.adding.coast.placeholder' bundle='${lang}'/>" name="coast" step="0.01" required>
        ...
        <input type="submit" class="btn btn-primary mt-4" value="<fmt:message key='product.adding.submit' bundle='${lang}'/>">
    </form>
</div>
</body>
<script>
